...
class ManageChildrenDialog(QDialog):
    def __init__(self, db):
        super().__init__()
        self.db = db
        self.setWindowTitle("管理孩子")
        layout = QVBoxLayout()
        ...
        btns.addWidget(add_btn); btns.addWidget(del_btn); btns.addWidget(setpwd_btn); btns.addWidget(close_btn)
